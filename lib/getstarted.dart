                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Your",
                      style: TextStyle(
                        fontSize: screenWidth * 0.16, // Adjusted font size for "Your"
                    ...
                    Text(
                      "tailored just",
                      style: TextStyle(
                        fontSize: screenWidth * 0.13, // Slightly smaller font size
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
                        height: .9,
                      ),
                    ...
                    Text(
                      "for you.",
                      style: TextStyle(
                        fontSize: screenWidth * 0.13, // Same size as "tailored just"
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
                        height: .9,
                      ),
